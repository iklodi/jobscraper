...
Uses the **Groq API** (or Gemini as a fallback) to evaluate each `pending` job.
...
4. **Rate Limits:** If Groq or Gemini hit rate limits, the script will automatically pause for 30 seconds and retry.
